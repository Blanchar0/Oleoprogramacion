  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      <button
        ...
        className="relative p-2 rounded-xl text-forest-800 hover:text-forest-950 hover:bg-forest-100/70 transition-all cursor-pointer flex items-center justify-center border border-forest-200 shadow-2xs"
        title="Centro de notificaciones y avisos"
        aria-label="Notificaciones"
      >
        <Bell size={20} className={unreadCount > 0 ? 'text-forest-900 animate-bounce' : 'text-forest-700'} />
        {unreadCount > 0 && (
